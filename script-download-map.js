...
// example: https://tiles1-v2.pubgmap.net/tiles/miramar/v5/5/31/31.png
const zooms = [0, 1, 2, 3, 4] // 5 might be too many
const baseurl = 'https://tiles1-v2.pubgmap.net/tiles' // tiles0-3 can be used, I think they are the same
const maps = ['elevation-erangel/v8', 'erangel/v11', 'miramar/v5', 'elevation-miramar/v4']
